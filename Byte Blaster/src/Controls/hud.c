...
static void drawPlayerLife(Gunner *g)
{
	...
	sprintf(text, "Rest: %d", g->rest);

	drawText(text, 10, SCREEN_HEIGHT - 55, 255, 255, 255, TEXT_ALIGN_LEFT, 0);
}
...
static void drawDebugInfo(void)
{
	...
	sprintf(text, "Collisions: %d", app.dev.collisionChecks);

	drawText(text, SCREEN_WIDTH - 10, SCREEN_HEIGHT - 60, 255, 255, 255, TEXT_ALIGN_RIGHT, 0);

	sprintf(text, "FPS: %d", app.dev.fps);

	drawText(text, SCREEN_WIDTH - 10, SCREEN_HEIGHT - 90, 255, 255, 255, TEXT_ALIGN_RIGHT, 0);
